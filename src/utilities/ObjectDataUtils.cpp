...
const hh::fnd::RflTypeInfo GOCVisualModelSpawner::rflTypeInfo{
...
const hh::fnd::RflTypeInfo GOCSimpleAnimationSpawner::rflTypeInfo{
...
const hh::fnd::RflTypeInfo GOCActivatorSpawner::rflTypeInfo{
	"GOCActivatorSpawner",
	"GOCActivatorSpawner",
	[](void* instance, csl::fnd::IAllocator* allocator) {
