...
Timeline::Timeline(csl::fnd::IAllocator* allocator, SurfRideEditor& editor) : BaseObject{ allocator }, editor{ editor }
{
}
...
void Timeline::Render()
{
	...
	ImGui::SetNextWindowPos(ImVec2(0, ImGui::GetMainViewport()->WorkSize.y - 575), ImGuiCond_FirstUseEver, ImVec2(1, 0));
	ImGui::SetNextWindowSize(ImVec2(1200, 550), ImGuiCond_FirstUseEver);
