...
namespace ui::operation_modes::modes::pcmodel_editor {
	...
	Eigen::Quaternionf FromEuler(const Eigen::Vector3f& rotation, RotationOrder rotationOrder) {
		switch (rotationOrder) {
		case RotationOrder::XYZ: return Eigen::AngleAxisf(rotation[0], Eigen::Vector3f::UnitX()) * Eigen::AngleAxisf(rotation[1], Eigen::Vector3f::UnitY()) * Eigen::AngleAxisf(rotation[2], Eigen::Vector3f::UnitZ());
		case RotationOrder::YZX: return Eigen::AngleAxisf(rotation[1], Eigen::Vector3f::UnitY()) * Eigen::AngleAxisf(rotation[2], Eigen::Vector3f::UnitZ()) * Eigen::AngleAxisf(rotation[0], Eigen::Vector3f::UnitX());
		case RotationOrder::ZXY: return Eigen::AngleAxisf(rotation[2], Eigen::Vector3f::UnitZ()) * Eigen::AngleAxisf(rotation[0], Eigen::Vector3f::UnitX()) * Eigen::AngleAxisf(rotation[1], Eigen::Vector3f::UnitY());
		case RotationOrder::XZY: return Eigen::AngleAxisf(rotation[0], Eigen::Vector3f::UnitX()) * Eigen::AngleAxisf(rotation[2], Eigen::Vector3f::UnitZ()) * Eigen::AngleAxisf(rotation[1], Eigen::Vector3f::UnitY());
		case RotationOrder::YXZ: return Eigen::AngleAxisf(rotation[1], Eigen::Vector3f::UnitY()) * Eigen::AngleAxisf(rotation[0], Eigen::Vector3f::UnitX()) * Eigen::AngleAxisf(rotation[2], Eigen::Vector3f::UnitZ());
		case RotationOrder::ZYX: return Eigen::AngleAxisf(rotation[2], Eigen::Vector3f::UnitZ()) * Eigen::AngleAxisf(rotation[1], Eigen::Vector3f::UnitY()) * Eigen::AngleAxisf(rotation[0], Eigen::Vector3f::UnitX());
