...
namespace ui::operation_modes::modes::surfride_editor {
	struct AddCastToLayerPayload {
		ucsl::resources::swif::v6::SRS_LAYER& layer;
		ucsl::resources::swif::v6::SRS_CASTNODE::Type type;
	};

	struct AddCastToCastPayload {
		ucsl::resources::swif::v6::SRS_CASTNODE& cast;
		ucsl::resources::swif::v6::SRS_CASTNODE::Type type;
	};
	...
	using SetFocusedSceneAction = Action<ActionId::SURFRIDE_EDITOR_SET_FOCUSED_SCENE, ucsl::resources::swif::v6::SRS_SCENE*>;
	...
	using RemoveCastAction = Action<ActionId::SURFRIDE_EDITOR_REMOVE_CAST, ucsl::resources::swif::v6::SRS_CASTNODE&>;
