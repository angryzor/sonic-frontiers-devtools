...
const RflClass RflClassTraitsImpl<SurfRide::Rotation3>::rflClass{ "SurfRideRotation3", nullptr, static_cast<uint32_t>(sizeof(SurfRide::Rotation3)), nullptr, 0, surfRideRotation3Members.data(), static_cast<uint32_t>(surfRideRotation3Members.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_PROJECT>::rflClass{ "SRS_PROJECT", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_PROJECT)), nullptr, 0, srsProjectMembers.data(), static_cast<uint32_t>(srsProjectMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_SCENE>::rflClass{ "SRS_SCENE", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_SCENE)), nullptr, 0, srsSceneMembers.data(), static_cast<uint32_t>(srsSceneMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_CAMERA>::rflClass{ "SRS_CAMERA", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_CAMERA)), nullptr, 0, srsCameraMembers.data(), static_cast<uint32_t>(srsCameraMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_LAYER>::rflClass{ "SRS_LAYER", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_LAYER)), nullptr, 0, srsLayerMembers.data(), static_cast<uint32_t>(srsLayerMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_TRS_BASE>::rflClass{ "SRS_TRS_BASE", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_TRS_BASE)), nullptr, 0, srsTrsBaseMembers.data(), static_cast<uint32_t>(srsTrsBaseMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_TRS2D>::rflClass{ "SRS_TRS2D", &RflClassTraits<SurfRide::SRS_TRS_BASE>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::SRS_TRS2D)), nullptr, 0, srsTrs2DMembers.data(), static_cast<uint32_t>(srsTrs2DMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_TRS3D>::rflClass{ "SRS_TRS3D", &RflClassTraits<SurfRide::SRS_TRS_BASE>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::SRS_TRS3D)), nullptr, 0, srsTrs3DMembers.data(), static_cast<uint32_t>(srsTrs3DMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_SLICE>::rflClass{ "SRS_SLICE", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_SLICE)), nullptr, 0, srsSliceMembers.data(), static_cast<uint32_t>(srsSliceMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_TEXTDATA>::rflClass{ "SRS_TEXTDATA", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_TEXTDATA)), nullptr, 0, srsTextDataMembers.data(), static_cast<uint32_t>(srsTextDataMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_CASTNODE>::rflClass{ "SRS_CASTNODE", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_CASTNODE)), nullptr, 0, srsCastNodeMembers.data(), static_cast<uint32_t>(srsCastNodeMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_IMAGECAST>::rflClass{ "SRS_IMAGECAST", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_IMAGECAST)), nullptr, 0, srsImageCastMembers.data(), static_cast<uint32_t>(srsImageCastMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_REFERENCECAST>::rflClass{ "SRS_REFERENCECAST", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_REFERENCECAST)), nullptr, 0, srsReferenceCastMembers.data(), static_cast<uint32_t>(srsReferenceCastMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_SLICECAST>::rflClass{ "SRS_SLICECAST", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_SLICECAST)), nullptr, 0, srsSliceCastMembers.data(), static_cast<uint32_t>(srsSliceCastMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_CROP>::rflClass{ "SRS_CROP", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_CROP)), nullptr, 0, srsCropMembers.data(), static_cast<uint32_t>(srsCropMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_CROPREF>::rflClass{ "SRS_CROPREF", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_CROPREF)), nullptr, 0, srsCroprefMembers.data(), static_cast<uint32_t>(srsCroprefMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_TEXTURE>::rflClass{ "SRS_TEXTURE", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_TEXTURE)), nullptr, 0, srsTextureMembers.data(), static_cast<uint32_t>(srsTextureMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_TEXTURELIST>::rflClass{ "SRS_TEXTURELIST", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_TEXTURELIST)), nullptr, 0, srsTextureListMembers.data(), static_cast<uint32_t>(srsTextureListMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_KEYFRAME>::rflClass{ "SRS_KEYFRAME", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_KEYFRAME)), nullptr, 0, srsKeyframeMembers.data(), static_cast<uint32_t>(srsKeyframeMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyLinear<float>>::rflClass{ "SRS_KEYFRAME_LINEAR_FLOAT", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyLinear<float>)), nullptr, 0, srsKeyframeKeyLinearFloatMembers.data(), static_cast<uint32_t>(srsKeyframeKeyLinearFloatMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyLinear<int>>::rflClass{ "SRS_KEYFRAME_LINEAR_INT", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyLinear<int>)), nullptr, 0, srsKeyframeKeyLinearIntMembers.data(), static_cast<uint32_t>(srsKeyframeKeyLinearIntMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyLinear<bool>>::rflClass{ "SRS_KEYFRAME_LINEAR_BOOL", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyLinear<bool>)), nullptr, 0, srsKeyframeKeyLinearBoolMembers.data(), static_cast<uint32_t>(srsKeyframeKeyLinearBoolMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyLinear<SurfRide::Color>>::rflClass{ "SRS_KEYFRAME_LINEAR_COLOR", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyLinear<SurfRide::Color>)), nullptr, 0, srsKeyframeKeyLinearColorMembers.data(), static_cast<uint32_t>(srsKeyframeKeyLinearColorMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyHermite<float>>::rflClass{ "SRS_KEYFRAME_HERMITE_FLOAT", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyHermite<float>)), nullptr, 0, srsKeyframeKeyHermiteFloatMembers.data(), static_cast<uint32_t>(srsKeyframeKeyHermiteFloatMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyHermite<int>>::rflClass{ "SRS_KEYFRAME_HERMITE_INT", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyHermite<int>)), nullptr, 0, srsKeyframeKeyHermiteIntMembers.data(), static_cast<uint32_t>(srsKeyframeKeyHermiteIntMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyHermite<bool>>::rflClass{ "SRS_KEYFRAME_HERMITE_BOOL", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyHermite<bool>)), nullptr, 0, srsKeyframeKeyHermiteBoolMembers.data(), static_cast<uint32_t>(srsKeyframeKeyHermiteBoolMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyHermite<SurfRide::Color>>::rflClass{ "SRS_KEYFRAME_HERMITE_COLOR", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyHermite<SurfRide::Color>)), nullptr, 0, srsKeyframeKeyHermiteColorMembers.data(), static_cast<uint32_t>(srsKeyframeKeyHermiteColorMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyIndividual<float>>::rflClass{ "SRS_KEYFRAME_INDIVIDUAL_FLOAT", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyIndividual<float>)), nullptr, 0, srsKeyframeKeyIndividualFloatMembers.data(), static_cast<uint32_t>(srsKeyframeKeyIndividualFloatMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyIndividual<int>>::rflClass{ "SRS_KEYFRAME_INDIVIDUAL_INT", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyIndividual<int>)), nullptr, 0, srsKeyframeKeyIndividualIntMembers.data(), static_cast<uint32_t>(srsKeyframeKeyIndividualIntMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyIndividual<bool>>::rflClass{ "SRS_KEYFRAME_INDIVIDUAL_BOOL", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyIndividual<bool>)), nullptr, 0, srsKeyframeKeyIndividualBoolMembers.data(), static_cast<uint32_t>(srsKeyframeKeyIndividualBoolMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::KeyIndividual<SurfRide::Color>>::rflClass{ "SRS_KEYFRAME_INDIVIDUAL_COLOR", &RflClassTraits<SurfRide::SRS_KEYFRAME>::rflClass, static_cast<uint32_t>(sizeof(SurfRide::KeyIndividual<SurfRide::Color>)), nullptr, 0, srsKeyframeKeyIndividualColorMembers.data(), static_cast<uint32_t>(srsKeyframeKeyIndividualColorMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_TRACK>::rflClass{ "SRS_TRACK", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_TRACK)), nullptr, 0, srsTrackMembers.data(), static_cast<uint32_t>(srsTrackMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_MOTION>::rflClass{ "SRS_MOTION", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_MOTION)), nullptr, 0, srsMotionMembers.data(), static_cast<uint32_t>(srsMotionMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_ANIMATION>::rflClass{ "SRS_ANIMATION", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_ANIMATION)), nullptr, 0, srsAnimationMembers.data(), static_cast<uint32_t>(srsAnimationMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_FONT>::rflClass{ "SRS_FONT", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_FONT)), nullptr, 0, srsFontMembers.data(), static_cast<uint32_t>(srsFontMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_CHARACTER_MAPPING>::rflClass{ "SRS_CHARACTER_MAPPING", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_CHARACTER_MAPPING)), nullptr, 0, srsCharacterMappingMembers.data(), static_cast<uint32_t>(srsCharacterMappingMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_DATA_BOOL>::rflClass{ "SRS_DATA_BOOL", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_DATA)), nullptr, 0, srsDataBoolMembers.data(), static_cast<uint32_t>(srsDataBoolMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_DATA_INT>::rflClass{ "SRS_DATA_INT", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_DATA)), nullptr, 0, srsDataIntMembers.data(), static_cast<uint32_t>(srsDataIntMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_DATA_UINT>::rflClass{ "SRS_DATA_UINT", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_DATA)), nullptr, 0, srsDataUintMembers.data(), static_cast<uint32_t>(srsDataUintMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_DATA_FLOAT>::rflClass{ "SRS_DATA_FLOAT", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_DATA)), nullptr, 0, srsDataFloatMembers.data(), static_cast<uint32_t>(srsDataFloatMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_DATA_STRING>::rflClass{ "SRS_DATA_STRING", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_DATA)), nullptr, 0, srsDataStringMembers.data(), static_cast<uint32_t>(srsDataStringMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_USERDATA>::rflClass{ "SRS_USERDATA", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_USERDATA)), nullptr, 0, srsUserDataMembers.data(), static_cast<uint32_t>(srsUserDataMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_BLUR>::rflClass{ "SRS_BLUR", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_BLUR)), nullptr, 0, srsBlurMembers.data(), static_cast<uint32_t>(srsBlurMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_BLUR3D>::rflClass{ "SRS_BLUR3D", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_BLUR3D)), nullptr, 0, srsBlurMembers.data(), static_cast<uint32_t>(srsBlurMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_REFLECT>::rflClass{ "SRS_REFLECT", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_REFLECT)), nullptr, 0, srsReflectMembers.data(), static_cast<uint32_t>(srsReflectMembers.size()), nullptr };
const RflClass RflClassTraitsImpl<SurfRide::SRS_REFLECT3D>::rflClass{ "SRS_REFLECT3D", nullptr, static_cast<uint32_t>(sizeof(SurfRide::SRS_REFLECT3D)), nullptr, 0, srsReflectMembers.data(), static_cast<uint32_t>(srsReflectMembers.size()), nullptr };
