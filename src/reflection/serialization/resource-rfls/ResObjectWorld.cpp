...
RflClassMember componentDataMembers[]{
    ...
    { "data", reinterpret_cast<RflClass*> (handleComponentDataData), nullptr, RflClassMember::TYPE_POINTER, RflClassMember::TYPE_STRUCT, 0, 0x1000, offsetof(ComponentData, data), nullptr },
};
...
RflClassMember objectDataMembers[]{
    ...
    { "spawnerData", reinterpret_cast<RflClass*>(handleSpawnerData), nullptr, RflClassMember::TYPE_POINTER, RflClassMember::TYPE_STRUCT, 0, 0x1000, offsetof(ObjectData, spawnerData), nullptr },
};
